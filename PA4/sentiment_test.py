...
class BaseModelTest(unittest.TestCase):
    ...
    def test_simple_prediction(self):
        """Test model accurately predicts observed word, with pseudo-counts"""
        ...
        np.testing.assert_array_equal(
            ...
            [True] * 2,
            "With pseudo counts probabilities should not be 0",
        )
...
class BaseModelFullDatasetTest(unittest.TestCase):
    ...
    def test_entire_dataset(self):
        """Test that reasonable accuracy obtained for provided test data"""
        ...
        self.assertGreater(accuracy, 0.7, "Accuracy should be greater than 0.70")
